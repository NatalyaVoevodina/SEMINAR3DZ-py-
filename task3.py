...
N = abs(int(input('Введите число, для подтверждения в какой раскладке написано Ваше слово (1-английская, 0- русская): ')))
if N == 1:
	print('Вы получаете', sum([k for i in word for k, v in eng.items() if i in v]), 'очков' )
	print('Благодарим Вас за игру!')
elif N == 0:
	print('Вы получаете', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
	print('Благодарим Вас за игру!')
else:
    print('Вы играете не по правилам! Мы за честную игру!')
    print('Попробуйте снова!!! Удачи :-)')